...
public class BGMusic_selector : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (SceneManager.GetActiveScene().name == "Main" && !GameManager.Instance.getWinnerGameId().Equals(""))
        {
            ...
            {
                Debug.Log("Main selected, I won the game, winTrack is not playing, ATTIVATA volte numero = " );
                loseTrack.Stop();
                menuTrack.Stop();
                gameTrack.Stop();
                conqueredTerritory.Stop();
            ...
            {
                Debug.Log("Main selected, I Lose the game, loseTrack is not playing, ATTIVATA volte numero = ");
                menuTrack.Stop();
                gameTrack.Stop();
                winTrack.Stop();
                conqueredTerritory.Stop();
